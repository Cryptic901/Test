...
public class UserController {
    ...
    @PostMapping("/create")
    @Operation(summary = "Создать пользователя", description = "Создаёт пользователя, при неверном введении отправляет статус 400")
    ...
    @GetMapping("/getAll")
    @Operation(summary = "Вернуть всех пользователей", description = "Возвращает список всех пользователей, если список пустой статус 204")
    ...
    @Operation(summary = "Получить пользователя по имени", description = "Возвращает пользователя у которого имя совпадает с введенным, если пользователь не найден статус 204")
    ...
    @Operation(summary = "Получить пользователя по ID", description = "Возвращает пользователя у которого ID совпадает с введенным, если пользователь не найден статус 204")
    ...
    @Operation(summary = "Удалить пользователя по ID", description = "Удаляет пользователя по ID отправляя статус 410, если не находит по id статус 204")
    ...
    @Operation(summary = "Занять книгу из библиотеки",
            description = "Занимает книгу из библиотеки, изменяет статус книги на BORROWED и добавляет в список занятых книг пользователем, если не находит статус 204")
    ...
    @Operation(summary = "Вернуть книгу в библиотеку",
            description = "Возвращает книгу в библиотеку, изменяет статус книги на AVAILABLE и удаляет из списка занятых книг пользователем, если не находит статус 204")
